!(function () {
    ...
    function n(e) {
        if (!e) return "";
        const t = e.id;
        return "object" == typeof t && null !== t && "baseVal" in t ? t.baseVal : t || "";
    }
    function o(e) {
        if (!e) return "";
        const t = e.className;
    ...
    function i(e) {
        return "object" == typeof e && null !== e && "baseVal" in e ? e.baseVal : String(e);
    }
    function a(e) {
        if (!e) return "";
        const t = n(e);
        ...
        for (; i && i !== document.body; ) {
            ...
            for (; t; ) t.tagName === i.tagName && e++, (t = t.previousElementSibling);
            (o = `/${i.tagName.toLowerCase()}[${e}]${o}`), (i = i.parentElement);
        }
        return `/html/body${o}`;
    }
    function l(e) {
    ...
    function r(e) {
        ...
        try {
            const t = e.getAttribute("data-lov-id") || "",
                a = t.split(":"),
                l = t,
                r = a.length >= 2 ? parseInt(a[1]) : null,
                s = a.length >= 3 ? parseInt(a[2]) : null,
                d = e.getAttribute("data-component-path") || "",
                c = e.getAttribute("data-component-file") || "",
                u = {};
            Array.from(e.attributes).forEach((e) => {
                e.name.startsWith("data-") || (u[e.name] = i(e.value));
            });
            const m = o(e);
            let g = {};
            try {
                const t = e.getAttribute("data-component-content");
                t && (g = JSON.parse(decodeURIComponent(t)));
            } catch (e) {
                console.warn("解析data-component-content失败:", e);
            }
            const f = e.textContent || "",
        ...
        (window.__sk_editor = {
            debounce: (e, t, n) => {
                let o,
                    ...
                    r,
                    s = 0;
                "boolean" == typeof n && (n = { leading: n, trailing: !n });
                const { leading: d = !1, trailing: c = !0, maxWait: u } = n || {},
                    m = "number" == typeof u;
                function g(t) {
                    const n = i,
                        o = a;
                    return (i = a = void 0), (s = t), (l = e.apply(o, n)), l;
                }
                function f(e) {
                    const n = e - r;
                    return void 0 === r || n >= t || n < 0 || (m && e - s >= u);
                }
                function p() {
                    const e = Date.now();
                    if (f(e)) return y(e);
                    o = setTimeout(
                        ...
                        (function (e) {
                            const n = e - s,
                                o = t - (e - r);
                            return m ? Math.min(o, u - n) : o;
                        })(e)
                    );
                }
                function y(e) {
                    return (o = void 0), c && i ? g(e) : ((i = a = void 0), l);
                }
                function E(...e) {
                    const n = Date.now(),
                        c = f(n);
                    if (((i = e), (a = this), (r = n), c)) {
                        if (void 0 === o)
                            return (function (e) {
                                return (s = e), (o = setTimeout(p, t)), d ? g(e) : l;
                            })(r);
                        if (m) return (o = setTimeout(p, t)), g(r);
                    }
                    return void 0 === o && (o = setTimeout(p, t)), l;
                }
                return (
                    (E.cancel = function () {
                        void 0 !== o && clearTimeout(o), (s = 0), (i = r = a = o = void 0);
                    }),
                    (E.flush = function () {
                        return void 0 === o ? l : y(Date.now());
                    }),
                    (E.pending = function () {
                        return void 0 !== o;
                    }),
            ...
            updateElementPosition: function (e, t) {
                ...
                const s = a(e),
                            ...
                            try {
                                ...
                                if (e && e.nodeType === Node.ELEMENT_NODE && e instanceof Element) {
                                    ...
                                    for (; -1 !== (o = n.indexOf(t, o + 1)); )
                                        if ((i++, n.slice(o, o + t.length) === t && e.outerHTML.trim() === t)) return i;
                                }
                            } catch (e) {}
                        let i = -1,
                            a = 0;
                        for (; -1 !== (i = n.indexOf(o, i + 1)); ) a++;
                        return a > 0 ? a : -1;
                    })(e.outerHTML, s),
                    c =
                        "IMG" === e.tagName && "FIGCAPTION" === e.nextElementSibling?.tagName
                    ...
                    g = r(e),
                    f = void 0 !== e.innerText ? e.innerText : e.textContent || "",
                    p = e.getBoundingClientRect(),
                    y = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth || 0;
                l({
                    type: "ELEMENT_SELECT",
                    payload: {
                        tagName: e.tagName,
                        ...
                        xPath: s,
                        focusType: t,
                        attributes: Array.from(e.attributes).reduce((e, t) => ((e[t.name] = i(t.value)), e), {}),
    ...
    (function () {
        let e = null,
            ...
            r = null,
            s = 0;
        const d = ["p", "h1", "h2", "h3", "h4", "h5", "h6", "span", "a"];
        function c() {
            const e = document.getElementById("highlightBox-tools");
            e && e.remove();
            const t = document.getElementById("hoverBox-tools");
            t && t.remove();
            const n = document.createElement("div");
            (n.id = "highlightBox-tools"),
            ...
            const o = window.frameElement,
                i = ["gen_ppt"].includes((o && o.getAttribute("data-type")) || "");
            (n.innerHTML = i
        ...
        function u(e, t, n, o = {}) {
            ...
            return (
                document.addEventListener(e, i, o),
                function () {
                    document.removeEventListener(e, i, o);
                }
            );
        }
        function m(e) {
        ...
        function f(n, o) {
            ...
            if (!i) {
                ...
                if (!t) return;
                (i = t.commonAncestorContainer), i.nodeType === Node.TEXT_NODE && (i = i.parentElement);
            }
            if (
                (function (e, t) {
                ...
                return void console.log("==========元素未修改，不添加编辑标识");
            if (
                (document.body.hasAttribute(MANUAL_EDIT_ATTR) ||
                    (console.log("==========添加手动编辑标识"), document.body.setAttribute(MANUAL_EDIT_ATTR, "true")),
                !g(i))
            ) {
                if (i.hasAttribute("data-sk-edited")) return;
                i.setAttribute("data-sk-edited", ""), console.log("已编辑", i);
            }
            const a = [],
                l = ["BODY", "DIV", "LI", "P"];
            !(function e(t) {
                ...
                if (l.indexOf(n) > -1) {
                    t.querySelectorAll(".sk-source-tag[data-sk-source-id]").forEach((e) => {
                        a.indexOf(e) > -1 && e.setAttribute("data-sk-source-delete", "");
                    });
                } else
                    a.push(
                        ...(function (e) {
        ...
        function p(e, t) {
            return t && console.log("_isIMGTag", e), !!m(e) || (e && "IMG" === e.tagName);
        }
        ...
        const y = ((e, t) => {
            ...
            window.__sk_editor.postMessageToParent({
                ...
                payload: {
                    ...
                    offset: { x: e.clientX - L.x, y: e.clientY - L.y },
                },
            });
        }, 16);
        function E(e, t = !1) {
            ...
            if (
                ...
                return t && console.log("元素通过 display 检查"), n;
            }
            if (p(n, t)) {
                const e = m(n);
                return e || n;
            ...
            let i;
            if (document.caretRangeFromPoint) i = document.caretRangeFromPoint(e.clientX, e.clientY);
            else if (document.caretPositionFromPoint) {
                const t = document.caretPositionFromPoint(e.clientX, e.clientY);
                t && (i = { startContainer: t.offsetNode, startOffset: t.offset });
            }
            if (i && i.startContainer && i.startContainer.nodeType === Node.TEXT_NODE) {
                const e = i.startContainer.parentElement;
                return e || null;
            }
            return null;
        }
        function h(e, t) {
            if (!e || !t || (!i && ((!p(t) && "CANVAS" !== t.tagName) || "hoverBox-tools" === e.getAttribute("id"))))
                return;
            const n = p(t) ? 8 : 4,
                o = p(t) ? 8 : 2,
                a = t.getBoundingClientRect();
            Object.assign(e.style, {
                left: window.scrollX + a.left - n + "px",
                top: window.scrollY + a.top - o + "px",
                width: a.width + 2 * n + "px",
                height: a.height + 2 * o + "px",
                display: "block",
            });
        ...
        function b() {
            ...
            e.removeAttribute("contenteditable"),
                ...
                0 === e.style.length &&
                    ...
                    (console.log("==========移除空的 style 属性"), e.removeAttribute("style")),
                e.blur(),
        ...
        function x(n = !1) {
            b(),
                e &&
                    (console.log("==========clearEditing _dynamicallyDeleteSource", e, t),
                    f(e, t),
                    (e.style.outline = ""),
                    (e = null),
                    (t = null));
        ...
        function T(e) {
            if (!e) return;
            h(document.getElementById("highlightBox-tools"), e), window.__sk_editor.updateElementPosition(e, "click");
        }
        let v = !1,
            N = null,
            L = { x: 0, y: 0 };
            ...
            e &&
                ...
                window.__sk_editor.postMessageToParent({
                    ...
                    payload: {
                        element: {
                            tagName: N.tagName,
                            id: window.__sk_editor.getIdSafe(N),
                            className: window.__sk_editor.getClassNameSafe(N),
                            xPath: window.__sk_editor.getXPath(N),
                        },
        ...
        setTimeout(() => {
            u("mousedown", "#drag-btn", A),
                u("mouseenter", "#drag-btn", () => {
                    const e = document.getElementById("drag-btn");
                    e && (e.style.cursor = "grab");
                }),
                u("mouseleave", "#drag-btn", () => {
                    const e = document.getElementById("drag-btn");
                    e && (e.style.cursor = "grab");
                });
        }, 0),
            document.addEventListener("mousemove", function (e) {
                ...
                !(function (e, t, n) {
                    ...
                    Object.assign(e.style, {
                        left: window.scrollX + a - o.width / 2 - 4 + "px",
            ...
            document.addEventListener("mouseup", function (e) {
                ...
                const n = e.clientX - L.x,
                    o = e.clientY - L.y;
                let i = N.style.transform || "",
                    a = i.match(/translate\(([-\d.]+)px,\s*([-\d.]+)px\)/),
                    l = 0,
                    r = 0;
                a &&
                    ((l = parseFloat(a[1])),
                    (r = parseFloat(a[2])),
                    (i = i.replace(/translate\(([-\d.]+)px,\s*([-\d.]+)px\)/, "")));
                const s = l + n,
                    d = r + o;
                (N.style.transform = `${i} translate(${s}px, ${d}px)`),
                ...
                c && (c.style.display = "none"),
                    ...
                    document.body.hasAttribute(MANUAL_EDIT_ATTR) ||
                        document.body.setAttribute(MANUAL_EDIT_ATTR, "true"),
                    C();
            }),
            document.addEventListener("mousemove", function (t) {
                ...
                const n = t.target,
                    o = E(t),
                    a = document.getElementById("highlightBox-tools"),
            ...
            document.addEventListener(
                ...
                function (n) {
                    ...
                    let o = (function (e) {
                        if ("HTML" !== e.target?.tagName && "BODY" !== e.target?.tagName) return null;
                        const t = document.querySelectorAll('button[role="combobox"]');
                        let n = null;
                        for (const o of t) {
                            ...
                            if (
                                ...
                                (n = o),
                                    console.log("✅ 坐标检测：点击了 combobox", {
                                        rect: { left: t.left, right: t.right, top: t.top, bottom: t.bottom },
                        ...
                        return n
                            ? (console.log("✅ 检测到点击 combobox，选中按钮"),
                              e.preventDefault(),
                              e.stopPropagation(),
                    ...
                    o || (o = n.target);
                    const a = E({ ...n, target: o, clientX: n.clientX, clientY: n.clientY }, !0),
                        c = document.getElementById("highlightBox-tools"),
                        u = document.getElementById("hoverBox-tools");
                    if (
                        (console.log("🎯 Click事件 - 检查元素:", {
                            真实点击元素_el: o?.tagName,
                            getEditableTarget返回el: a ? a.tagName : null,
                            是否相同: o === a,
                            el是否为空: !a,
                            el是highlightBox: a === c,
                            el是hoverBox: a === u,
                        ...
                        !a ||
                            a === c ||
                            a === u ||
                            (o !== a && "svg" !== a.nodeName && "BUTTON" !== a.tagName) ||
                            a.hasAttribute("data-sk-reference-id"))
                    )
                        return void console.log("❌ Click事件 - 元素被过滤，不处理");
                    if ((console.log("✅ Click事件 - 元素通过检查，继续处理"), !i && !p(o) && "CANVAS" !== o.tagName))
                        return void x(!0);
                    const m = Date.now(),
                        g = l === a && m - s < 300;
                    (l = a), (s = m);
                    const f = d.includes(a.tagName.toLowerCase());
                    if (g && f)
                        return (function (e) {
                            if (!e) return !1;
                            try {
                            ...
                            ? void (function (e) {
                                  if (!e || r === e) return;
                                  b(), (r = e), e.setAttribute("contenteditable", "true");
                                  const t = window.getComputedStyle(e),
                                      n = t.color,
                                      o = t.backgroundImage;
                                  if (
                                      ("rgba(0, 0, 0, 0)" === n || "transparent" === n) &&
                                      o &&
                                      o.includes("gradient")
                                  ) {
                                      const t = o.match(/rgba?\(\d+,\s*\d+,\s*\d+(?:,\s*[\d.]+)?\)/g);
                                      if (t && t.length > 0) {
                                          const n = Math.floor(t.length / 2);
                                          e.style.caretColor = t[n];
                                      } else e.style.caretColor = "#333";
                                  } else
                                      ("rgba(0, 0, 0, 0)" !== n && "transparent" !== n) ||
                                          (e.style.caretColor = "#333");
                                  if (
                                      ((e.style.outline = "0px solid #00EBBE"),
                                  ...
                                  console.log("进入文本编辑态:", e),
                                      window.__sk_editor.postMessageToParent({
                                          ...
                                          payload: {
                                              tagName: e.tagName,
                                              id: window.__sk_editor.getIdSafe(e),
                                              className: window.__sk_editor.getClassNameSafe(e),
                                              xPath: window.__sk_editor.getXPath(e),
                            ...
                            : void window.__sk_editor.postMessageToParent({
                                  ...
                                  payload: {
                                      tagName: a.tagName,
                                      id: window.__sk_editor.getIdSafe(a),
                                      className: window.__sk_editor.getClassNameSafe(a),
                                      xPath: window.__sk_editor.getXPath(a),
                                      message: "该元素不支持文本编辑",
                                  },
                              });
                    const y = e === a;
                    e && e !== a && (e.style.outline = ""),
                        y || ((e = a), (t = a.cloneNode(!0))),
                        ...
                        window.__sk_editor.postMessageToParent({
                            ...
                            payload: {
                                ...
                                draggHandler: document
                                    .getElementById("highlightBox-tools")
                                    ?.innerHTML?.includes("drag-btn"),
                            },
                        }),
                        setTimeout(() => {
                            T(a);
            ...
            document.addEventListener("mousedown", function (t) {
                ...
                r && o !== r && b(), o !== e && n && !n.contains(o) && x();
            });
        const D = window.__sk_editor.debounce(function (t) {
            h(document.getElementById("highlightBox-tools"), e);
            const n = window.__sk_editor.parseDomInfo(e),
                o = e?.getAttribute("data-component-name");
            if (!n) return;
            _({ type: "editText", path: n.file_path, line: n.line_number, componentName: o, newText: n.text_content }),
                C();
        }, 300);
        function k(e) {
            const t = window.getSelection();
        ...
        const I = window.__sk_editor.debounce(
            function () {
                window.__sk_editor.postMessageToParent({
                    type: "IFRAME_SCROLL",
                    payload: {
        ...
        function C(o, i = !1) {
            window.__sk_editor.postMessageToParent({
                ...
                payload: { html: n, immediate: !0, action: a },
            }),
                o || f(e, t),
                i || T(e),
                setTimeout(() => {
        ...
        function M(e) {
            ...
            if ((console.log("targetElement by xPath:", t), !t && e.lovId)) {
                const n = e.lovId;
                try {
                    t = document.querySelector(`[data-lov-id="${n}"]`);
                } catch (e) {
                    console.error("data-lov-id 查询失败:", e);
                }
            }
            return console.log("targetElement by lovId:", t), t;
        }
        function S() {
            const e = ["highlightBox-tools", "hoverBox-tools"],
                ...
                o = Array.from(document.body.childNodes).filter(
        ...
        window.addEventListener("scroll", I, { passive: !0 }),
            (window.onblur = () => {
                console.log("iframe onblur"),
                    (o = setTimeout(() => {
                        x(), console.log("iframe onblur clearEditing");
                    }, 800));
            }),
            window.addEventListener("load", function () {
                setTimeout(() => {
        ...
        window.addEventListener("message", function (t) {
            if ("UPDATE_ELEMENT" === t.data.type)
                !(function (t) {
                    ...
                    if (t.replaceElement) {
                        ...
                        i && (n.replaceWith(i), (e = i));
                    }
                    C(null === t.attributes?.["data-sk-edited"]);
                })(t.data.payload),
                    _(t.data.payload?.action);
            else if ("DELETE_ELEMENT" === t.data.type)
                !(function (e) {
                    const t = M(e);
                    t && t instanceof Element && (t.setAttribute("data-sk-deleted", ""), C());
                })(t.data.payload),
                    _(t.data.payload?.action);
                ...
                !(function (t, n) {
                    ...
                    n.heading && n.heading !== t.tagName.toLowerCase()
                        ...
                        : (R(t, n), (o = t));
                    C(), window.focus();
                })(n, t.data.payload?.styles);
            } else if ("APPLY_ELEMENT_CLASSES" === t.data.type) {
                const e = M(t.data.payload);
                if (!(e && e instanceof Element)) return;
                !(function (e, t, n) {
                    if (!(e && e instanceof Element)) return;
                    try {
                        (e.className = t), C(), window.focus();
                    } catch (e) {
            ...
            } else if ("CLEAR_EDITING" === t.data.type) x(t.data.payload?.notPostMessage), clearTimeout(o);
                ...
                i = !!t.data.payload?.isEditMode;
                let e = document.getElementById("hoverBox-tools"),
                    n = document.getElementById("highlightBox-tools");
                e && n && ((e.style.display = i ? "block" : "none"), (n.style.display = i ? "block" : "none")),
                    x(),
                    (function (e) {
                        const t = "sk-editor-combobox-style",
                        ...
                        if (e) {
                            if (!n) {
                                ...
                                (e.id = t),
                                    ...
                                    document.head.appendChild(e),
                                    console.log("✅ 已添加通用 combobox 隐藏样式（编辑模式）");
                            }
                        } else n && (n.remove(), console.log("✅ 已移除 combobox 隐藏样式（预览模式）"));
                    })(i);
                ...
                try {
                    if (window.__sk_editor && "function" == typeof window.__sk_editor[e])
                        i = window.__sk_editor[e].apply(window.__sk_editor, n || []);
                    else {
                        const t = window[e];
                ...
                window.__sk_editor.postMessageToParent({
                    ...
                    payload: { requestId: o, result: i, error: a },
                });
            }
            var n;
        }),
